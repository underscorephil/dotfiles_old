    ...
    sh -c "`curl -fsSL https://raw.github.com/underscorephil/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.github.com/underscorephil/dotfiles/master/install.sh`" -s ask
```
